...
if {[file isfile PRNumGen.autotvin.dat]} {
	file delete -force PRNumGen.autotvin.dat
}

if {[file isfile PRNumGen.autotvout.dat]} {
	file delete -force PRNumGen.autotvout.dat
}
