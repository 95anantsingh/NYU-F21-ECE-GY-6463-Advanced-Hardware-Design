...
proc check_tvin_file {} {
    ...
    set rtlfilelist {
         "c.PRNumGen.autotvin_rstn.dat"
         "c.PRNumGen.autotvin_get_random.dat"
         "c.PRNumGen.autotvin_load_seed.dat"
         "c.PRNumGen.autotvin_data_in.dat"
         "c.PRNumGen.autotvout_data_out.dat"
    }
...
proc check_tvout_file {} {
    ...
    set rtlfilelist {
         "rtl.PRNumGen.autotvout_data_out.dat"
    }
    foreach rtlfile $rtlfilelist {
        if {[file isfile $rtlfile]} {
        } else {
