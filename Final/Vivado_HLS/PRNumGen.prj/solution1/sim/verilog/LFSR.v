...
always @ (*) begin
    if (((ap_start == 1'b1) & (w_en_read_read_fu_66_p2 == 1'd0) & (rstn_read_read_fu_72_p2 == 1'd1) & (1'b1 == ap_ce) & (1'b1 == ap_CS_fsm_state1))) begin
        d_out_ap_vld = 1'b1;
    end else begin
        d_out_ap_vld = 1'b0;
    end
...
always @ (*) begin
    ap_condition_34 = ((ap_start == 1'b1) & (1'b1 == ap_ce) & (1'b1 == ap_CS_fsm_state1));
end
